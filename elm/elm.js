...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			A3($author$project$Main$Model, key, url, $author$project$Route$Home),
			$elm$core$Platform$Cmd$none);
	});
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Route$Running = {$: 'Running'};
...
var $author$project$Main$changeRouteTo = F2(
	function (maybeRoute, model) {
		if (maybeRoute.$ === 'Nothing') {
			return _Utils_Tuple2(
				model,
				A2($author$project$Route$replaceUrl, model.key, $author$project$Route$Home));
		} else {
			if (maybeRoute.a.$ === 'Home') {
				...
				return _Utils_Tuple2(
					model,
					A2($author$project$Route$replaceUrl, model.key, $author$project$Route$Running));
			}
		}
	});
...
var $author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'ClickedLink') {
			...
			return A4(
				$elm$core$Debug$log,
				'Changed route to: ' + $elm$url$Url$toString(url),
...
var $author$project$Running$Page$viewLink = function (path) {
	return A2(
		$elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Running$Page$view = function (model) {
	return {
		body: _List_fromArray(
			[
				$elm$html$Html$text('Its running!'),
				A2(
				$elm$html$Html$b,
				_List_Nil,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$author$project$Running$Page$viewLink('/home')
					]))
			]),
		title: 'Running!'
	};
...
var $author$project$Main$viewLink = function (route) {
	return A2(
		$elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
		...
		return {
			body: _List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Main$viewLink($author$project$Route$Home),
							$author$project$Main$viewLink($author$project$Route$Running)
						]))
				]),
			title: 'Home!'
		};
	} else {
		return $author$project$Running$Page$view(model);
	}
};
